<?php
/**
 * $Id: install.xmap.php 144 2010-10-27 04:18:14Z guilleva $
 * $LastChangedDate: 2010-10-26 23:18:14 -0500 (Tue, 26 Oct 2010) $
...
if ( file_exists( $pathLangFile . $tmp_lng . '.php' )){
    ...
    <table border="0" width="90%">
	    <tr>
		    ...
		    <td width="80%"><b>Xmap 1.2.10 Stable</b></td>
	    </tr>
	    <tr>
		...
		<tr>
			...
			<br />
			<font color="green"><b>Xmap 1.2.10 has been installed successfully! Thank you for using Xmap! Settings can be configured in the <a href="index.php?option=com_xmap">&rarr; component menu</a>!</b></font><br /><br />
			<br /></td>
		</tr>
	    <tr>
	      <td>&nbsp;</td>
