...
<?php endif; ?>
					...
					<?php endif; ?>
						  ...
						  <div class="art-content<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
						  <?php echo JFilterOutput::ampReplace($this->item->text);  ?>
						  <div class="readmore">
							<a href="<?php echo $this->item->readmore_link; ?>" class="readmore<?php echo $this->escape($this->item->params->get('pageclass_sfx')); ?>"><?php echo JText::sprintf('Read more', $this->escape($this->item->title)); ?></a>
						  </div>
...
<div class="sec-art-header">
	<div class="art-title">
		<h2<?php //echo $this->escape($this->item->params->get('pageclass_sfx')); ?>>
	<?php if ($this->item->params->get('link_titles') && $this->item->readmore_link != '') : ?>
...
<div class="readmore">
	<a href="<?php echo $this->item->readmore_link; ?>" class="readmore<?php echo $this->escape($this->item->params->get('pageclass_sfx')); ?>">
