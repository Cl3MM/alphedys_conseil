...
<?php
	...
	if (!is_null( $feed->title ) && $params->get('rsstitle', 1)) :
		?>
		<h4><a href="<?php echo str_replace( '&', '&amp', $feed->link ); ?>" target="_blank"><?php echo $feed->title; ?></a></h4>
	<?php endif; ?>
...
<?php
	...
	?>
	<li ><?php echo $feed->description; ?></li><?php
	}

	// feed image
	if ($params->get('rssimage', 1) && $iUrl) {
	?>
	<li class="rightmenuitem"><img src="<?php echo $iUrl; ?>" alt="<?php echo @$iTitle; ?>"/></li>
	<?php
	}
	...
	for ($j = 0; $j < $totalItems; $j ++)
	{
		...
		?>
			<a class="rightmenuitem" href="<?php echo $currItem->get_link(); ?>" target="_blank">
