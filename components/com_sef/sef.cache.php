...
class SEFCacheItem
{
    ...
    function SEFCacheItem($nonsef, $sefurl, $hits, $Itemid = '', $metatitle = '', $metadesc = '', $metakey = '', $metalang = '', $metarobots = '', $metagoogle = '', $canonicallink = '', $enabled = '1', $sef = '1')
    {
        $this->sefurl = $sefurl;
        $this->origurl = $nonsef;
        $this->cpt = $hits;
...
class SEFCache
{
     ...
     */
    function addUrl($nonsef, $sefurl, $hits, $Itemid = '', $metatitle = '', $metadesc = '', $metakey = '', $metalang = '', $metarobots = '', $metagoogle = '', $canonicallink = '', $enabled = '1', $sef = '1')
    {
        ...
        $cacheItem = new SEFCacheItem($nonsef, $sefurl, $hits, $Itemid, $metatitle, $metadesc, $metakey, $metalang, $metarobots, $metagoogle, $canonicallink, $enabled, $sef);
